...
impl Universe {
    ...
    // Exercises 4.4 (1)
    pub fn new_single() -> Universe {
        let width = 64;
        let height = 64;
        let rand = (js_sys::Math::random() * (width as f64) * (height as f64)) as u32;
...
impl BitUniverse {
    pub fn new() -> BitUniverse {
        ...
        BitUniverse { width, height, cells, }
    }

    pub fn tick(&mut self) {
        let _timer = Timer::new("BitUniverse::tick");
        let mut next = {
